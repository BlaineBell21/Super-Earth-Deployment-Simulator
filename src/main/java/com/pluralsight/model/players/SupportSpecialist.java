...
public class SupportSpecialist extends Helldiver{
    ...
    public SupportSpecialist(String helldiverName, String callsign, Weapon primaryWeapon, Specialty specialty, int combatRating, int health, int stamina, int armorRating, boolean isAlive) {
